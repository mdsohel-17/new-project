    ...
    <>
      <div className="bg-white lg:h-screen -mt-20 px-20">
        <div className="flex flex-wrap h-full -mx-3">
          ...
          <div className="flex flex-wrap justify-between px-2 -mx-3 -my-3 pb-10 items-end">
            <div className="  w-full sm:w-6/12 order-1 lg:order-1 lg:w-3/12 px-3 py-3">
            ...
            <div className=" lg:w-6/12 order-3 lg:order-2 px-3 py-3">
            ...
            <div className=" w-full sm:w-6/12 lg:w-3/12 order-2 lg:order-3 py-3  px-3">
